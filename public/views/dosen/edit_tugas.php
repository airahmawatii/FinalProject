...
=======
<body class="bg-gradient-to-br from-indigo-900 via-blue-900 to-slate-900 min-h-screen flex items-center justify-center p-4">

    <div class="w-full max-w-5xl flex gap-8 items-start">
        
        <!-- Sidebar Navigation -->
        <div class="hidden md:block w-64 sidebar rounded-3xl p-6 h-[500px] flex flex-col justify-between text-white shadow-2xl">
            <div>
                <h2 class="text-2xl font-bold text-blue-900 mb-8 flex items-center gap-2">
                    <span>⚡</span> TaskAcademia
                </h2>
                <nav class="space-y-2">
                    <a href="dashboard.php" class="block px-4 py-3 rounded-xl hover:bg-white/10 text-slate-300 font-semibold transition">
                        🏠 Dashboard
                    </a>
                    <a href="buat_tugas.php" class="block px-4 py-3 rounded-xl hover:bg-white/10 text-slate-300 font-semibold transition">
                        ➕ Buat Tugas
                    </a>
                    <a href="daftar_tugas.php" class="block px-4 py-3 rounded-xl bg-blue-600 text-white font-semibold transition shadow-lg shadow-blue-500/30">
                        📋 Daftar Tugas
                    </a>
                    <a href="profile.php" class="block px-4 py-3 rounded-xl hover:bg-white/10 text-slate-300 font-semibold transition">
                         👤 Profil Saya
                    </a>
                </nav>
            </div>
            <a href="/public/logout.php" class="block px-4 py-3 text-red-500 hover:text-red-400 rounded-xl font-semibold transition">
                🚪 Logout
            </a>
        </div>

        <!-- Main Form -->
        <main class="flex-1 glass rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
            <div class="relative z-10">
                <div class="flex justify-between items-center mb-8">
                    <h1 class="text-3xl font-bold text-gray-800">Edit Tugas</h1>
                    <a href="daftar_tugas.php" class="text-gray-400 hover:text-gray-600 text-sm font-bold bg-gray-100 px-4 py-2 rounded-lg">Kembali</a>
                </div>
                ...
                <form method="POST" class="space-y-6">
                    ...
                    <div class="pt-6 flex gap-4">
                        ...
                        <a href="daftar_tugas.php" class="px-8 py-4 rounded-xl border border-gray-200 text-gray-600 font-bold hover:bg-gray-50 transition">
                            Batal
                        </a>
                    </div>
