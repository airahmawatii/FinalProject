...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($model->create($_POST['nama_kelas'], $_POST['prodi_id'], $_POST['angkatan_id'])) {
...
<body class="bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 min-h-screen p-8 flex items-center justify-center font-outfit">
    ...
    <div class="fixed inset-0 pointer-events-none z-0">
        ...
        <div class="absolute bottom-[-10%] left-[-5%] w-[400px] h-[400px] bg-cyan-600/10 rounded-full blur-[100px] mix-blend-screen"></div>
    </div>
    ...
    <div class="w-full max-w-xl glass p-10 rounded-[2.5rem] shadow-2xl relative z-10 border border-white/20 overflow-hidden">
        ...
        <div class="flex justify-between items-center mb-10">
            <div>
                <h2 class="text-3xl font-bold text-white tracking-tight">Tambah Kelas</h2>
                <p class="text-blue-300/60 text-sm mt-1">Buat rombongan belajar baru untuk mahasiswa.</p>
            </div>
        ...
        <form method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    <label class="block text-[10px] font-extrabold text-blue-300 uppercase tracking-widest ml-1">Tahun Angkatan</label>
                    <div class="relative">
