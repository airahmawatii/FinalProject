...
<body class="bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 min-h-screen p-8 flex items-center justify-center font-outfit">
    ...
    <div class="w-full max-w-xl glass p-10 rounded-[2.5rem] shadow-2xl relative z-10 border border-white/20 overflow-hidden">
        ...
        <div class="flex justify-between items-center mb-10">
            <div>
                <h2 class="text-3xl font-bold text-white tracking-tight">Tambah Angkatan</h2>
                <p class="text-blue-300/60 text-sm mt-1">Daftarkan tahun angkatan akademik baru.</p>
            </div>
        ...
        <form method="POST" class="space-y-6">
            <div class="space-y-2">
                ...
                <input type="number" name="tahun" required placeholder="Contoh: 2024" min="2000" max="2100"
                       class="w-full px-5 py-4 glass rounded-2xl focus:ring-4 focus:ring-blue-500/20 focus:outline-none text-white placeholder-blue-300/30 border-white/10 transition-all text-xl font-bold">
            </div>
